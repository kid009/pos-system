                        ...
                        <div class="dropdown">
                            <button
                                ...
                                <div class="me-2 text-end d-none d-lg-block">
                                    <span class="small text-gray-600 d-block">ยินดีต้อนรับ</span>
                            ...
                            <div class="modal-content border-0 shadow-lg">
                                <div class="modal-header bg-danger text-white">
                                    <h5 class="modal-title">
                                        <i class="fas fa-exclamation-triangle me-2"></i> ยืนยันการออกจากระบบ
                                    </h5>
                                    <button type="button" class="btn-close btn-close-white"
                                        @click="logoutModalOpen = false"></button>
                                </div>
                                <div class="modal-body py-4 text-center">
                                    <h5 class="mb-2">ต้องการออกจากระบบหรือไม่?</h5>
                                    <p class="text-muted mb-0">เลือก "ออกจากระบบ" ด้านล่างหากคุณต้องการสิ้นสุดการใช้งานในปัจจุบัน</p>
                                </div>
