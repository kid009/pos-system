            ...
            <div class="d-flex gap-2">
                <form action="{{ route('products.index') }}" method="GET" class="d-flex">
                    <div class="input-group input-group-sm">
                        <input type="text" name="search" class="form-control" placeholder="ค้นหาชื่อ/รหัสสินค้า..."
                            value="{{ $search }}">
                        <button class="btn btn-outline-secondary" type="submit"><span data-feather="search"
                                style="width: 14px;"></span></button>
                    </div>
                </form>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <div class="bg-secondary rounded d-flex align-items-center justify-content-center"
                                                ...
                                                <span data-feather="image" class="text-white"
                                                    style="width: 20px; height: 20px;"></span>
                                            </div>
                                        @endif
                                    </td>
                                    <td><span
                                            class="badge bg-secondary rounded-pill px-2 fw-normal">{{ $product->sku }}</span>
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center text-muted py-5">
                                        <span data-feather="box" style="width: 48px; height: 48px;"
                                            class="mb-2 text-secondary"></span>
