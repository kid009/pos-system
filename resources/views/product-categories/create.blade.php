<x-app-layout>
    <x-slot:title>Add Product Category</x-slot:title>

    <div class="max-w-2xl mx-auto space-y-6">

        <div class="flex items-center justify-between pb-2 border-b border-slate-200">
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-slate-900">Add Product Category</h1>
                <p class="text-sm text-slate-500 mt-0.5">Create a new classification group for catalog items.</p>
            </div>
            <div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <form action="{{ route('product-categories.store') }}" method="POST" class="p-6 space-y-6" novalidate>
                @csrf
